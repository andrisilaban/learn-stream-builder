...
abstract class $SingleDataCopyWith<$Res> {
  factory $SingleDataCopyWith(
      ...
      _$SingleDataCopyWithImpl<$Res, SingleData>;
  @useResult
  $Res call(
      {int? id,
      String? email,
...
/// @nodoc
class _$SingleDataCopyWithImpl<$Res, $Val extends SingleData>
...
/// @nodoc
class __$$_SingleDataCopyWithImpl<$Res>
    extends _$SingleDataCopyWithImpl<$Res, _$_SingleData>
...
/// @nodoc
@JsonSerializable()
class _$_SingleData implements _SingleData {
  _$_SingleData(
      {this.id,
      this.email,
  ...
  @override
  String toString() {
    return 'SingleData(id: $id, email: $email, firstName: $firstName, lastName: $lastName, avatar: $avatar)';
  }
...
abstract class _SingleData implements SingleData {
  factory _SingleData(
      {final int? id,
      final String? email,
      @JsonKey(name: 'first_name') final String? firstName,
      @JsonKey(name: 'last_name') final String? lastName,
      final String? avatar}) = _$_SingleData;
